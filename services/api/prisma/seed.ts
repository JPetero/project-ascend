...
const EXERCISES: ExerciseSeed[] = [
  {
    ...
    description:
      'A compound lower-body lift: a loaded barbell across the upper back, squatting to depth and standing back up.',
    instructions:
    ...
    commonMistakes:
      'Letting the knees cave inward, rounding the lower back, or rising onto the toes instead of driving through the heels.',
  ...
  },
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A compound upper-body push: pressing a loaded barbell from the chest to full arm extension while lying on a bench.',
    instructions:
    ...
    safetyTips:
      'Always use a spotter or safety arms when lifting near your limit. Keep your feet flat on the floor and shoulder blades pulled together.',
    commonMistakes:
      'Bouncing the bar off the chest, flaring the elbows to 90 degrees, or lifting the hips off the bench.',
  ...
  },
  {
    ...
    safetyTips:
      'Keep the bar close to your shins and thighs the whole lift. Never round your lower back to force a rep — lower the weight instead.',
    commonMistakes:
      'Letting the bar drift away from the body, hyperextending at the top, or starting with the hips too low (turning it into a squat).',
  ...
  },
  {
    ...
    safetyTips:
      'Avoid arching the lower back excessively to compensate for limited shoulder mobility — keep glutes and core braced.',
    commonMistakes:
      'Pressing the bar forward instead of straight up, or using leg drive without intending to (turning it into a push press).',
  ...
  },
  {
    ...
    safetyTips:
      'Keep your lower back neutral throughout — if it starts to round, reduce the weight.',
    commonMistakes:
      'Using momentum (jerking the torso up) instead of pulling with the back, or rowing to the wrong height.',
    primaryMuscles: ['back'],
    secondaryMuscles: ['arms'],
    equipment: ['barbell'],
  },
  {
    ...
    safetyTips:
      'Keep your elbows tucked at your sides and avoid using momentum from your hips or shoulders.',
    commonMistakes:
      'Swinging the weight up using body momentum, or only performing a partial range of motion.',
    primaryMuscles: ['arms'],
    equipment: ['dumbbell'],
  },
  {
    ...
    safetyTips:
      'Avoid locking the elbows aggressively at the top, and keep your core braced to protect your lower back.',
    commonMistakes:
      'Arching the lower back excessively, or letting the dumbbells drift forward instead of pressing straight up.',
    primaryMuscles: ['shoulders'],
    secondaryMuscles: ['arms'],
    equipment: ['dumbbell'],
  },
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A single-leg strength exercise stepping forward into a lunge while holding dumbbells.',
    instructions:
    ...
    safetyTips:
      'Keep your front knee tracking over your foot, not caving inward, and avoid letting the back knee slam into the floor.',
    commonMistakes:
      'Taking too short a step (limiting range of motion), or leaning the torso too far forward.',
    primaryMuscles: ['legs', 'glutes'],
    equipment: ['dumbbell'],
  },
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A ballistic hip-hinge movement that swings a kettlebell from between the legs to chest height using hip drive.',
    instructions:
    ...
    safetyTips:
      'The power comes from the hips, not the arms or lower back — never squat the movement or muscle it up with your shoulders.',
    commonMistakes:
      'Squatting instead of hinging, or using the arms to lift the bell instead of hip drive.',
  ...
  },
  {
    ...
    safetyTips:
      'Keep your core and glutes braced so your hips don’t sag or pike during the movement.',
    commonMistakes:
      'Letting the hips sag, flaring the elbows straight out to the sides, or only performing a partial range of motion.',
    primaryMuscles: ['chest'],
  ...
  },
  {
    ...
    safetyTips:
      'Avoid kipping or swinging momentum if training strength rather than a specific kipping skill.',
  ...
  },
  {
    ...
    measurementType: MeasurementType.BODYWEIGHT,
    description:
      'A fundamental lower-body movement squatting down and standing back up using only body weight.',
    instructions:
  ...
  },
  {
    ...
    description:
      'An isometric core hold, supporting the body in a straight line on the forearms and toes.',
    instructions:
    ...
    safetyTips:
      'Stop if your lower back starts to sag or ache — that means your core has fatigued and form is breaking down.',
  ...
  },
  {
    ...
    measurementType: MeasurementType.DURATION,
    description:
      'A dynamic bodyweight exercise driving the knees toward the chest from a plank position at pace.',
    instructions:
    ...
    safetyTips:
      'Keep your hands firmly planted and your core tight to avoid your hips bouncing excessively.',
    commonMistakes:
      'Letting the hips rise too high (turning it into a hip-flexor stretch rather than a conditioning movement).',
    primaryMuscles: ['core'],
  ...
  },
  {
    ...
    safetyTips:
      'Step back into the plank instead of jumping if you need to protect your lower back or wrists.',
    commonMistakes:
      'Letting the hips sag during the plank/push-up phase, or skipping the full squat depth on landing.',
    primaryMuscles: ['legs'],
  ...
  },
  {
    ...
    measurementType: MeasurementType.REPS_ONLY,
    description:
      'A pulling exercise for the back using a resistance band anchored in front of the body.',
    instructions:
    ...
    commonMistakes:
      'Using the arms alone without engaging the back, or leaning back excessively to add momentum.',
    primaryMuscles: ['back'],
    secondaryMuscles: ['arms'],
  ...
  },
  {
    ...
    safetyTips:
      'Keep your knees tracking over your toes and avoid standing fully upright between steps, which releases band tension.',
    commonMistakes:
      'Standing too upright (losing glute engagement), or taking steps that are too large and unstable.',
  ...
  },
  {
    ...
    safetyTips:
      'Move within a comfortable range — this should never be painful, only a gentle stretch.',
    commonMistakes:
      'Moving too fast to actually mobilize the spine, or only moving the neck instead of the whole spine.',
    primaryMuscles: ['back'],
    secondaryMuscles: ['core'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.REPS_ONLY,
    description:
      'A multi-plane dynamic stretch combining a lunge, rotation, and hamstring stretch in one flow.',
    instructions:
    ...
    safetyTips:
      'Move slowly and only rotate as far as feels comfortable in your hips and thoracic spine.',
    commonMistakes:
      'Rushing through the positions instead of holding each briefly, or letting the front knee collapse inward.',
    primaryMuscles: ['legs'],
  ...
  },
  {
    ...
    safetyTips:
      'Avoid rolling directly over the knee joint itself, and keep pressure moderate rather than maximal.',
    commonMistakes:
      'Rolling too quickly to allow the tissue to actually release, or rolling directly over a joint.',
    primaryMuscles: ['legs'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.BODYWEIGHT,
    description:
      'An isolation exercise for the calves, rising onto the toes and lowering back down.',
    instructions:
    ...
    safetyTips:
      'Perform the movement through a full range of motion rather than small, fast bounces.',
    commonMistakes:
      'Bouncing through a short range of motion, or leaning on support instead of doing the work.',
  ...
  // --- Bodyweight regressions and core work -------------------------------
  {
    ...
    measurementType: MeasurementType.BODYWEIGHT,
    description:
      'A push-up regression using an elevated surface to reduce the load, for building toward a standard push-up.',
    instructions:
      'Place both hands on a stable elevated surface (bench, step, or sturdy table) slightly wider than shoulder-width. Walk your feet back until your body forms a straight line, then lower your chest to the surface and press back up.',
    safetyTips:
      'Use a surface that will not slide or tip. Keep your core braced so your hips do not sag.',
    commonMistakes:
      'Letting the hips sag or pike up, or only lowering a few inches instead of a full range of motion.',
    primaryMuscles: ['chest'],
    secondaryMuscles: ['shoulders', 'arms'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.BODYWEIGHT,
    description:
      'A push-up regression performed from the knees instead of the toes, for building pressing strength.',
    instructions:
      'Start on hands and knees, hands slightly wider than shoulder-width, and cross your ankles behind you. Keep a straight line from knees to head, lower your chest toward the floor, then press back up.',
    safetyTips: 'Keep the core braced throughout rather than letting the lower back sag.',
    commonMistakes:
      'Letting the hips pike up to make the movement easier, or flaring the elbows to 90 degrees.',
    primaryMuscles: ['chest'],
    secondaryMuscles: ['shoulders', 'arms'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.DURATION,
    description:
      'An isometric lower-body hold with the back against a wall and knees bent to roughly 90 degrees.',
    instructions:
      'Stand with your back against a wall and slide down until your thighs are roughly parallel to the floor, knees over ankles. Hold the position, keeping your back flat against the wall.',
    safetyTips:
      'Stop if you feel sharp knee pain — mild muscular fatigue in the thighs is expected, joint pain is not.',
    commonMistakes:
      'Letting the knees drift past the toes, or resting hands on the thighs to take weight off the legs.',
    primaryMuscles: ['legs'],
  ...
  },
  {
    ...
    measurementType: MeasurementType.BODYWEIGHT,
    description:
      'A hip-hinge exercise lying on your back, raising the hips by squeezing the glutes.',
    instructions:
      'Lie on your back with knees bent and feet flat on the floor, hip-width apart. Drive through your heels to lift your hips until your body forms a straight line from shoulders to knees, squeezing your glutes at the top, then lower under control.',
    safetyTips:
      'Avoid overextending the lower back at the top — the lift should come from the glutes, not an arched spine.',
    commonMistakes:
      'Pushing through the toes instead of the heels, or not fully extending the hips at the top.',
    primaryMuscles: ['glutes'],
    secondaryMuscles: ['legs', 'core'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.DURATION,
    description:
      'A prone isometric hold that lightly extends the spine to build lower-back and glute endurance.',
    instructions:
      'Lie face down with arms extended in front of you. Simultaneously lift your arms, chest, and legs a few inches off the floor, and hold briefly before lowering.',
    safetyTips:
      'This is a gentle extension, not a maximal arch — keep the range of motion small and controlled, especially if you have any back sensitivity.',
    commonMistakes:
      'Yanking upward instead of lifting smoothly, or holding the breath instead of breathing normally.',
    primaryMuscles: ['back'],
    secondaryMuscles: ['glutes'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.REPS_ONLY,
    description:
      'A core-stability exercise performed on the back, moving opposite arm and leg while keeping the spine still.',
    instructions:
      'Lie on your back with arms reaching toward the ceiling and knees bent at 90 degrees above your hips. Slowly lower one arm overhead and the opposite leg toward the floor while keeping your lower back pressed into the floor, then return and switch sides.',
    safetyTips:
      'Only lower the arm/leg as far as you can while keeping your lower back flat on the floor.',
    commonMistakes:
      'Letting the lower back arch off the floor, or moving too fast to control the position.',
    primaryMuscles: ['core'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.REPS_ONLY,
    description:
      'A core-stability exercise on hands and knees, extending the opposite arm and leg while keeping the torso still.',
    instructions:
      'Start on hands and knees, hands under shoulders and knees under hips. Extend one arm forward and the opposite leg back until both are roughly parallel to the floor, hold briefly, then return and switch sides.',
    safetyTips: 'Keep the hips level throughout — avoid rotating the torso to gain extra range.',
    commonMistakes:
      'Arching the lower back, or moving quickly instead of holding each position briefly.',
    primaryMuscles: ['core'],
  ...
  },
  {
    ...
    instructions:
      'Stand facing a sturdy step or bench. Place one foot fully on the surface, drive through that heel to stand up onto it, then step back down under control. Alternate legs.',
    safetyTips:
      'Use a step height you can control without your back knee needing to help push you up.',
    commonMistakes:
      'Pushing off the trailing leg instead of driving through the stepping leg, or using a step that is too high.',
    primaryMuscles: ['legs'],
    secondaryMuscles: ['glutes'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.BODYWEIGHT,
    description:
      'A bodyweight squat regression that uses a chair as a depth guide and safety net for beginners.',
    instructions:
      'Stand in front of a sturdy chair with feet shoulder-width apart. Bend your knees and hips to lower yourself until you lightly touch the seat, then stand back up. Use it as a checkpoint, not a full rest between reps.',
    safetyTips:
      'Make sure the chair will not slide. Keep the descent controlled rather than dropping onto the seat.',
    commonMistakes:
      'Fully sitting down and pausing between every rep, or letting the knees cave inward.',
    primaryMuscles: ['legs'],
    secondaryMuscles: ['glutes'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    instructions:
      'Lie on your side with your elbow under your shoulder. Lift your hips until your body forms a straight line from ankles to head, hold, then repeat on the other side.',
    safetyTips:
      'Stack your feet or stagger them for balance — whichever keeps your hips level without pain.',
    commonMistakes:
      'Letting the hips sag toward the floor, or rotating the torso forward or backward.',
    primaryMuscles: ['core'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    instructions:
      'Lie on your back with hands lightly behind your head and knees bent above your hips. Bring one elbow toward the opposite knee while extending the other leg, then switch sides in a smooth pedaling motion.',
    safetyTips: 'Avoid pulling on your neck with your hands — let your core do the work.',
    commonMistakes:
      'Moving too fast to keep tension in the core, or fully straightening the extended leg to the floor.',
    primaryMuscles: ['core'],
    equipment: ['bodyweight-equipment'],
  },
  // --- Dumbbell -------------------------------------------------------------
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A squat variation holding a single dumbbell at the chest, a beginner-friendly way to learn squat mechanics.',
    instructions:
      'Hold a dumbbell vertically against your chest with both hands. Squat down, keeping your chest up and elbows tracking inside your knees, until your thighs are at least parallel to the floor, then stand back up.',
    safetyTips:
      'The front-loaded weight naturally encourages an upright torso — if you feel yourself folding forward, reduce the weight.',
  ...
  },
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A hip-hinge exercise with dumbbells that targets the hamstrings and glutes through a controlled lowering phase.',
    instructions:
      'Hold a dumbbell in each hand in front of your thighs. Keeping a slight bend in the knees and your back flat, hinge at the hips to lower the dumbbells along your legs until you feel a stretch in your hamstrings, then drive your hips forward to stand back up.',
    safetyTips:
      'Keep the dumbbells close to your legs throughout, and stop the descent once your back would need to round to go further.',
    commonMistakes:
      'Rounding the lower back, or turning it into a squat by bending the knees too much.',
    primaryMuscles: ['legs', 'glutes'],
  ...
  },
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A pressing exercise lying on a bench or floor, pressing a dumbbell in each hand up from the chest.',
    instructions:
      'Lie on a bench (or the floor) holding a dumbbell in each hand at chest level, elbows bent. Press the dumbbells up until your arms are extended, then lower them back under control.',
    safetyTips:
      'Choose a weight you can lower under control — dropping the dumbbells at the bottom risks shoulder strain.',
    commonMistakes:
      'Flaring the elbows out to 90 degrees, or letting the dumbbells drift together or apart unevenly.',
    primaryMuscles: ['chest'],
    secondaryMuscles: ['shoulders', 'arms'],
    equipment: ['dumbbell'],
  },
  {
    ...
    instructions:
      'Hinge forward at the hips with a flat back, holding a dumbbell in each hand hanging below your shoulders. Pull the dumbbells up toward your ribs, squeezing your shoulder blades together, then lower under control.',
    safetyTips:
      'Keep the hinge angle you can hold with a flat back — if your back rounds, stand up a bit taller.',
  ...
  },
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'An isolation exercise raising dumbbells out to the sides to target the shoulders.',
    instructions:
      'Stand holding a light dumbbell in each hand at your sides. With a slight bend in the elbows, raise both arms out to the sides until roughly shoulder height, then lower under control.',
    safetyTips:
      'Use a light weight — this is an isolation movement, and swinging a heavy weight up risks shoulder impingement.',
    commonMistakes:
      'Using momentum/swinging instead of a controlled raise, or raising the arms above shoulder height.',
    primaryMuscles: ['shoulders'],
    equipment: ['dumbbell'],
  },
  {
    ...
    instructions:
      'Hold one dumbbell with both hands overhead, arms extended. Bend your elbows to lower the dumbbell behind your head, keeping your upper arms still, then extend back up.',
    safetyTips: 'Keep your elbows pointed forward and close to your head rather than flaring out.',
    commonMistakes:
      'Letting the elbows flare out wide, or using a weight heavy enough that the lower back arches to compensate.',
    primaryMuscles: ['arms'],
    equipment: ['dumbbell'],
  },
  // --- Barbell ---------------------------------------------------------------
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A glute-focused hip extension exercise with the upper back supported on a bench and a barbell across the hips.',
    instructions:
      'Sit on the floor with your upper back against a bench and a padded barbell across your hips. Drive through your heels to extend your hips until your body forms a straight line from shoulders to knees, then lower under control.',
    safetyTips:
      'Use a barbell pad and start with light weight to find a comfortable hip position before adding load.',
    commonMistakes:
      'Hyperextending the lower back at the top instead of stopping at a straight line, or pushing through the toes.',
    primaryMuscles: ['glutes'],
    secondaryMuscles: ['legs'],
    equipment: ['barbell'],
  },
  {
    ...
    measurementType: MeasurementType.REPS_WEIGHT,
    description:
      'A hip-hinge exercise lowering a barbell along the legs to target the hamstrings and glutes.',
    instructions:
      'Hold a barbell in front of your thighs with an overhand grip. Keeping a slight bend in the knees and a flat back, hinge at the hips to lower the bar along your legs until you feel a hamstring stretch, then drive your hips forward to return to standing.',
    safetyTips:
      'Keep the bar close to your legs throughout. Stop the descent once your back would need to round to go further.',
  ...
  // --- Resistance band ---------------------------------------------------
  {
    ...
    measurementType: MeasurementType.REPS_ONLY,
    description:
      'A shoulder and upper-back exercise pulling a resistance band apart at chest height.',
    instructions:
      'Hold a resistance band with both hands, arms extended in front of you at chest height. Pull the band apart by drawing your hands out to the sides, squeezing your shoulder blades together, then return under control.',
    safetyTips:
      'Choose a band tension that lets you complete the movement smoothly without jerking.',
    commonMistakes:
      'Bending the elbows to make the pull easier, or using momentum instead of a controlled squeeze.',
    primaryMuscles: ['back'],
    secondaryMuscles: ['shoulders'],
    equipment: ['resistance-band'],
  },
  {
    ...
    instructions:
      'Stand on the middle of a resistance band with feet hip-width apart, holding an end in each hand at your sides. Curl your hands toward your shoulders, keeping your elbows close to your body, then lower under control.',
    safetyTips:
      'Check the band for wear before use, and keep tension on it throughout rather than letting it go slack.',
    commonMistakes:
      'Swinging the upper arms forward to help the curl, or moving too fast to control the return.',
    primaryMuscles: ['arms'],
    equipment: ['resistance-band'],
  },
  {
    ...
    instructions:
      'Stand on the middle of a resistance band with feet shoulder-width apart, holding an end in each hand at shoulder height. Press both hands straight overhead, then lower back to shoulder height under control.',
    safetyTips: 'Brace your core to avoid arching your lower back as you press overhead.',
    commonMistakes:
      'Pressing the hands forward instead of straight up, or arching the back to gain range of motion.',
    primaryMuscles: ['shoulders'],
    secondaryMuscles: ['arms'],
    equipment: ['resistance-band'],
  },
  // --- Mobility ---------------------------------------------------------
  {
    ...
    measurementType: MeasurementType.DURATION,
    description:
      'A static stretch in a half-kneeling position to lengthen the hip flexors of the rear leg.',
    instructions:
      'Kneel on one knee with the other foot planted in front, both at roughly 90 degrees. Gently shift your hips forward until you feel a stretch in the front of the rear hip, keeping your torso upright. Hold, then switch sides.',
    safetyTips:
      'Place a cushion under the kneeling knee if the floor is hard. Move into the stretch gradually rather than forcing it.',
    commonMistakes:
      'Arching the lower back to fake extra range instead of moving from the hip, or bouncing in and out of the stretch.',
    primaryMuscles: ['legs'],
    secondaryMuscles: ['glutes'],
    equipment: ['bodyweight-equipment'],
  },
  {
    ...
    measurementType: MeasurementType.DURATION,
    description:
      'A seated hip-mobility stretch with both legs bent at roughly 90 degrees in opposite rotations.',
    instructions:
      'Sit on the floor with your front leg bent 90 degrees in front of you and your back leg bent 90 degrees out to the side. Keeping your chest tall, lean gently forward over the front shin. Hold, then switch sides.',
    safetyTips:
      'Work within a comfortable range — hip mobility varies a lot between people, so avoid forcing the position.',
    commonMistakes:
      'Rounding the back to lean further forward instead of hinging from the hips, or forcing a position that causes pinching pain.',
    primaryMuscles: ['glutes'],
    secondaryMuscles: ['legs'],
    equipment: ['bodyweight-equipment'],
  },
  // --- Walking and running ------------------------------------------------
  {
    ...
    description:
      'Continuous walking at a purposeful pace, the foundation cardio entry point for any fitness level.',
    instructions:
      'Walk at a pace where you can hold a conversation but feel your breathing rate increase — noticeably faster than a stroll. Maintain that pace for the planned duration or distance.',
    safetyTips:
      'Wear supportive footwear and choose a flat, well-lit route if walking outdoors. Stop if you feel dizzy, chest pain, or unusual shortness of breath.',
    commonMistakes:
      'Walking so slowly it provides little cardio benefit, or starting too fast and being unable to sustain the pace.',
    primaryMuscles: ['legs'],
  ...
  },
  {
    ...
    measurementType: MeasurementType.DISTANCE_DURATION,
    description:
      'A conversational-pace run intended to build aerobic base without excessive fatigue.',
    instructions:
      'Run at a pace where you could still speak in short sentences. If you cannot, slow down — this session is about consistent aerobic time, not speed.',
    safetyTips:
      'Warm up with a few minutes of walking first. Stop and walk if you feel joint pain, chest pain, or lightheadedness.',
    commonMistakes:
      'Running every session at maximum effort, which raises injury risk and undermines aerobic-base building.',
    primaryMuscles: ['legs'],
  ...
  },
  {
    ...
    instructions:
      'Alternate a harder-effort running segment with an easy jogging or walking recovery segment, repeating for the planned number of rounds. The hard segments should feel challenging but sustainable for their duration.',
    safetyTips:
      'Only add interval work once a comfortable easy-run base is established. Skip this session if you are dealing with any leg or foot pain.',
    commonMistakes:
      'Sprinting all-out on the hard segments (unsustainable and injury-prone) instead of a controlled hard effort, or cutting recovery segments short.',
    primaryMuscles: ['legs'],
    secondaryMuscles: ['calves', 'core'],
    equipment: [],
  },
...
const WORKOUTS: WorkoutSeed[] = [
  {
    ...
    difficulty: ExerciseDifficulty.INTERMEDIATE,
    description:
      'A balanced full-body strength session covering the major lower- and upper-body movement patterns.',
  ...
  },
  {
    ...
    exercises: [
      ...
      {
        exercise: 'foam-roll-quad-release',
        order: 3,
        targetSets: 1,
  ...
  // of programming exist than are actually seeded here.
  {
    ...
    difficulty: ExerciseDifficulty.BEGINNER,
    description:
      'A beginner-friendly full-body strength session using approachable variations of the major lifts.',
    estimatedDurationMinutes: 40,
    exercises: [
      {
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.BEGINNER,
    description:
      'A no-equipment full-body session you can do anywhere, using bodyweight-only movements and their regressions.',
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.INTERMEDIATE,
    description:
      'A complete strength session using only a pair of dumbbells, covering every major movement pattern.',
    estimatedDurationMinutes: 45,
    exercises: [
      {
        exercise: 'dumbbell-goblet-squat',
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.INTERMEDIATE,
    description:
      'An introductory session touching both an upper- and lower-body pattern, for anyone starting an upper/lower split. One representative session — plan the alternating days yourself for now.',
    estimatedDurationMinutes: 45,
    exercises: [
      { exercise: 'barbell-back-squat', order: 1, targetSets: 4, targetReps: 8, restSeconds: 120 },
      {
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.INTERMEDIATE,
    description:
      'An introductory session touching a push, a pull, and a leg pattern, for anyone starting a push/pull/legs split. One representative session — plan the rotating days yourself for now.',
    estimatedDurationMinutes: 45,
    exercises: [
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.BEGINNER,
    description:
      'A bodyweight-only strength session for building toward pull-ups, push-ups, and core control.',
    estimatedDurationMinutes: 30,
    exercises: [
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.BEGINNER,
    description:
      'A gentle mobility and recovery session for rest days or as a warm-up before training.',
    estimatedDurationMinutes: 15,
    exercises: [
      {
        exercise: 'cat-cow-stretch',
      ...
      {
        exercise: 'ninety-ninety-hip-stretch',
        order: 4,
        targetSets: 2,
        targetDurationSeconds: 30,
        restSeconds: 15,
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.BEGINNER,
    description:
      'A low-impact cardio session built entirely around brisk walking, for anyone starting a cardio habit.',
  ...
  },
  {
    ...
    difficulty: ExerciseDifficulty.BEGINNER,
    description:
      'An easy-effort running session with a short interval finisher, for anyone starting a running habit.',
    estimatedDurationMinutes: 25,
    exercises: [
      {
        exercise: 'easy-run',
